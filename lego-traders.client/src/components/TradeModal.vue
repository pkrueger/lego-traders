        ...
        <form @submit="offerTrade()">
          ...
          <div class="modal-content">
            ...
            <div class="input-group px-3">
              ...
              <textarea v-model="editable.body" class="form-control" aria-label="With textarea"></textarea>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" data-bs-dismiss="modal">Offer
                Set</button>
            </div>
          </div>
        </form>
    ...
    return {
      ...
      async offerTrade() {
        try {
          ...
          await marketplaceService.offerTrade(editable.value)
          editable.value = {}
