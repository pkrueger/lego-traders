<template>
  ...
  <div class="container-fluid px-4 bg-light">
    <div class="row py-3">
      <div class="col-12 d-flex gap-5 justify-content-center pb-3">
        ...
        <a
          ...
          "
          target="_blank"
          title="Search set on Google Shopping"
        >
    ...
    <div class="row" v-if="mocSets.length">
      ...
      <div
        class="col-12 col-md-12 col-lg-3 d-flex justify-content-center p-3 border-test"
        v-for="m in mocSets"
      >
        <div class="card moc-card text-center">
          <a :href="m.moc_url" target="_blank">
            <img
              :src="m.moc_img_url"
              title="Rebrickable set details"
              class="img-fluid moc-img pointer"
            />
          </a>
    ...
    <div class="row">
      ...
      <div class="col-md-6 d-flex justify-content-end order-sm-3">
        <div class="d-flex" v-if="owners.length > 0">
          ...
          <div v-for="o in owners">
            <router-link
              :to="{ name: 'Profile', params: { profileId: o.owner.id } }"
            >
              <img
                :src="o.owner?.picture"
                alt="user picture"
      ...
      <div
        class="col-sm-12 col-md-7 card bg-grey p-2 m-3 order-sm-3"
  ...
  <!-- OffCanvas -->
  <div
    class="offcanvas offcanvas-end overflow2 container-fluid"
    tabindex="-1"
    id="offcanvasRight"
  ...
  >
    <div class="row">
      ...
      <div
        class="offcanvas-body overflow bg-primary col-sm-12 col-md-6 col-lg-2"
        v-for="s in setParts"
      >
        <a :href="s.part.part_url" target="_blank">
          <div class="d-flex justify-content-center part-border">
            <img
              :src="s.part.part_img_url"
              :title="s.part.name"
              class="part-img"
            />
          </div>
