<template>
  <div class="container-fluid steps-page bg-success">
    <div class="row">
      <div class="col-12 my-4">
        <div class="bg-dark p-4 rounded">
          <div class="text-center">
            ...
            <img
              :src="mocSet.moc_img"
              alt="Final Creation Img"
              class="img-fluid final-img"
            />
          </div>
          <div class="px-5 my-4">
      ...
      <MOCStepCard
        v-for="step in mocSet.moc_steps"
        :key="step.text"
        :step="step"
      />
      <div class="col-12 my-4">
      ...
      <div class="col-12 my-4">
        <div
          class="bg-dark p-4 rounded d-flex justify-content-around align-items-center"
        >
          <h1>By: {{ mocSet.creator?.name }}</h1>
          <img
            :src="mocSet.creator?.picture"
            alt="Creator Picture"
